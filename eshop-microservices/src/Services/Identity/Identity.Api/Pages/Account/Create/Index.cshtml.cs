...
using Identity.Api.Pages.Login;
        ...
        public async Task<IActionResult> OnPost() 
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    ...
                    var result = await _userManager.CreateAsync( user, Input.PasswordConfirm);
                    if (result.Succeeded)
                    {
                    ...
                    {
                        ModelState.AddModelError(string.Empty,$"Something went wrong!: {result.Errors.ToArray()}");
                    }
                ...
                else if (user != null) ModelState.AddModelError(string.Empty, RegisterOptions.ExistedUserErrorMessage);
